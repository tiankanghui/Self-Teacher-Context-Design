...
class OPSDTrainer(SFTTrainer):
    ...
    def __init__(
        ...
        hint_level: str = "L1",
        shared_bridge: bool = False,
        routed_bridge: bool = False,
    ):
            ...
            if self.vllm_mode == "server":
                ...
                self.vllm_engine = LLM(
                    ...
                    * self.args.gradient_accumulation_steps,
                    ...
                    # Preserve the original rank-based seeds by default, but
                    # allow replication jobs to select a disjoint seed block.
                    # Ranks inside one TP group must still share a seed.
                    seed=(
                        int(os.environ.get("OPSD_ROLLOUT_SEED_BASE", "0"))
                        + self.accelerator.process_index // self.vllm_tensor_parallel_size
                    ),
